...
export function activate(context: vscode.ExtensionContext): void {
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand("mauiDev.permissions", () => run("permissions")),
    vscode.commands.registerCommand("mauiDev.platform", () => run("platform")),
    vscode.commands.registerCommand("mauiDev.signing", () => run("signing")),
    vscode.commands.registerCommand("mauiDev.workload", () => run("workload")),
    vscode.commands.registerCommand("mauiDev.version", () => run("version")),
    vscode.commands.registerCommand("mauiDev.dependencies", () => run("dependencies")),
    vscode.commands.registerCommand("mauiDev.icons", () => run("icons")),
    vscode.commands.registerCommand("mauiDev.publish", () => run("publish", ["--validate"])),
    vscode.commands.registerCommand("mauiDev.migrate", () => run("migrate")),
    vscode.commands.registerCommand("mauiDev.telemetry", () => run("telemetry")),
    vscode.commands.registerCommand("mauiDev.benchmark", () => run("benchmark")),
